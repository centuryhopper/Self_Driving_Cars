...
#region Public
    ...
    /// <summary>
    /// InitializeAgent() is called once, automatically, when the agent wakes up.
    /// It is not called every time the agent is reset, which is why there is a
    /// separate ResetAgent() function. We’ll use it to find a few objects in our Scene.
    /// </summary>
...
#region Private
    ...
    /// <summary>
    /// If true, penguin has a full stomach
    /// </summary>
    private bool isFull;
