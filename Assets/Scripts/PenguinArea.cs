...
/// <summary>
/// manage a training area with one penguin, one baby, and multiple fish.
/// It has the responsibilities of removing fish, spawning fish, and random
/// placement of the penguins. There might be multiple PenguinAreas in a Scene
/// for more efficient training.
/// </summary>
public class PenguinArea : MonoBehaviour
{
    /// <summary>
    /// These variables will keep track of important objects in the Scene.
    /// You will hook up objects to the public variables in Unity later in this tutorial.
    /// </summary>
    ...
    [SerializeField] int fishCount = 4;

    private List<GameObject> fishList = null;
    ...
    private void RemoveAllFish()
    {
        ...
        fishList = new List<GameObject>(fishCount);
    }
